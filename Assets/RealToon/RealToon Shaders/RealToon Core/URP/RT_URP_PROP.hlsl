...
UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
	...
	UNITY_DOTS_INSTANCED_PROP(float, _NorMapAsDis) 
...
static float unity_DOTS_Sampled_TessellationSmoothness;
static float unity_DOTS_Sampled_TessellationTransition;
static float unity_DOTS_Sampled_TessellationNear;
static float unity_DOTS_Sampled_TessellationFar;
static float unity_DOTS_Sampled_NorMapAsDis;
...
void SetupDOTSLitMaterialPropertyCaches()
{
    ...
    unity_DOTS_Sampled_TessellationSmoothness								= UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _TessellationSmoothness);
    unity_DOTS_Sampled_TessellationTransition								= UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _TessellationTransition);
    unity_DOTS_Sampled_TessellationNear										= UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _TessellationNear);
    unity_DOTS_Sampled_TessellationFar										= UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _TessellationFar);
	unity_DOTS_Sampled_NorMapAsDis											= UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _NorMapAsDis);
...
#define _NorMapAsDis									unity_DOTS_Sampled_NorMapAsDis
